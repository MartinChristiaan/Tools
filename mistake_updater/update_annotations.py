...
for i in range(len(mistake_files)):
    try:
        ...
        for i, false_neg in false_neg_df.iterrows():
            ...
            best_annotation_index = (
                None  # Initialize the index of the best matching annotation
            )
