...
def find_video_file_extensions(directory):
	video_extensions = [".mp4", ".avi", ".mkv", ".mov", ".wmv", ".flv", ".tiff", ".tif",'.jpg']
	video_files = []
...
def generate_yaml_file(videoset_name, videos: List[VideoInfo],dataset):
	...
	obj = VideosetII(
		...
		log_column=find_appropriate_timestamp_col(videos[0].path,videos[0].annotations),
...
if __name__ == "__main__":
	...
	parser.add_argument(
		"--config", type=str, default="configs/datasets.yaml"
	)
