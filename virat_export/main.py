...
sourcedir = Path(r'\mnt\dl-41\data\leeuwenmcv\mantis\VIRAT Ground Dataset'.replace('\\','/'))
...
for v in videos:
	...
	try:
		with open(annotations,'r') as f:
			text = f.read()
		annot_filename =  camera_annotations_dir/(get_annotations_filename(annotations)+".csv")
